...
class Core_Migration_ManagerTest extends ControllerTestCase
{
    ...
    public function testParseAffectedTables()
    {
        //given
        $manager = $this->_getManager();
        $text = file_get_contents(__DIR__ . '/_env/sqlDataForParsing.txt');

        //when
        $actualResult = $manager->parseAffectedTables($text);

        //then
        $this->assertEquals(11, count($actualResult));
    }
